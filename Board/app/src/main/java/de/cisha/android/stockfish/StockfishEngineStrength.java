...
public class StockfishEngineStrength
{
    ...
    public StockfishEngineStrength(final int elo) {
        this.elo = elo;
    }
    
    public StockfishEngineStrength(final Rating rating) {
        this.elo = rating.getRating();
    }
    
    private float getAdjustedElo() {
        float n2;
        final float n = n2 = this.elo;
        if (n < 1600.0f) {
            n2 = n - (1600.0f - n);
        }
        return n2;
    ...
    public float getBigBlunderEvalDiff() {
        return (2800.0f - this.elo) / 180.0f;
    }
    ...
    public float getSmallBlunderEvalDiff() {
        return (3000.0f - this.elo) / 1000.0f;
    }
