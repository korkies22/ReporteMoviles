...
implements ITournamentConnection {
    ...
    final /* synthetic */ ITournamentConnection.TournamentChangeListener val$changeListener;
    final /* synthetic */ ITournamentConnection.TournamentConnectionListener val$listener;

    DummyTournamentService(ITournamentConnection.TournamentConnectionListener tournamentConnectionListener, ITournamentConnection.TournamentChangeListener tournamentChangeListener) {
        this.val$listener = tournamentConnectionListener;
        this.val$changeListener = tournamentChangeListener;
    }
    ...
    public void connect() {
        ...
        this._timer.schedule(new TimerTask(){
            ...
            @Override
            public void run() {
                1.this.val$listener.connectionEstablished(DummyTournamentService.this._connection);
            }
        }, 300L);
    }
