...
import de.cisha.android.board.widget.TournamentsWidgetProvider;
...
@TargetApi(value=14)
public class TournamentWidgetService
extends RemoteViewsService {
    ...
    private List<TournamentInfo> _tournamentInfos = new LinkedList<TournamentInfo>();

    private void refreshTournamentsList(Context context) {
        ComponentName componentName = new ComponentName(this.getApplicationContext(), TournamentsWidgetProvider.class);
        context = AppWidgetManager.getInstance((Context)context);
        context.notifyAppWidgetViewDataChanged(context.getAppWidgetIds(componentName), 2131297182);
    }
    ...
    class TournamentRemoteViewsFactory
    implements RemoteViewsService.RemoteViewsFactory {
        ...
        public TournamentRemoteViewsFactory(Context context) {
