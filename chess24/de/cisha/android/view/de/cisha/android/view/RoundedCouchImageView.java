...
public class RoundedCouchImageView
extends CouchImageView {
    private int _cornerRadius;

    public RoundedCouchImageView(Context context) {
        super(context);
        this.init();
    }

    public RoundedCouchImageView(Context context, AttributeSet attributeSet) {
