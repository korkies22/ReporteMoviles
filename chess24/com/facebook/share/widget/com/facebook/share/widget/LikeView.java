...
extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            attributeSet = this.getContext().obtainStyledAttributes(attributeSet, R.styleable.com_facebook_like_view);
            if (attributeSet == null) {
                return;
            }
            this.objectId = Utility.coerceValueIfNullOrEmpty(attributeSet.getString(R.styleable.com_facebook_like_view_com_facebook_object_id), null);
            this.objectType = ObjectType.fromInt(attributeSet.getInt(R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
            this.likeViewStyle = Style.fromInt(attributeSet.getInt(R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
            if (this.likeViewStyle == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'style'");
            }
            this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(attributeSet.getInt(R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
            if (this.auxiliaryViewPosition == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'auxiliary_view_position'");
            }
            this.horizontalAlignment = HorizontalAlignment.fromInt(attributeSet.getInt(R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
            if (this.horizontalAlignment == null) {
                throw new IllegalArgumentException("Unsupported value for LikeView 'horizontal_alignment'");
            }
            this.foregroundColor = attributeSet.getColor(R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
            attributeSet.recycle();
            return;
        }
    }

    private void setObjectIdAndTypeForced(String string, ObjectType objectType) {
        ...
        if (!this.isInEditMode()) {
            LikeActionController.getControllerForObjectId(string, objectType, this.creationCallback);
        }
    }
    ...
    private void updateLayout() {
        block13 : {
            ...
            block12 : {
                block11 : {
                    object = (FrameLayout.LayoutParams)this.containerView.getLayoutParams();
                    layoutParams = (LinearLayout.LayoutParams)this.likeButton.getLayoutParams();
                    n = this.horizontalAlignment == HorizontalAlignment.LEFT ? 3 : (this.horizontalAlignment == HorizontalAlignment.CENTER ? 1 : 5);
                    object.gravity = n | 48;
                    layoutParams.gravity = n;
                    this.socialSentenceView.setVisibility(8);
                    this.likeBoxCountView.setVisibility(8);
                    if (this.likeViewStyle != Style.STANDARD || this.likeActionController == null || Utility.isNullOrEmpty(this.likeActionController.getSocialSentence())) break block11;
                    object = this.socialSentenceView;
                    break block12;
                }
                if (this.likeViewStyle != Style.BOX_COUNT || this.likeActionController == null || Utility.isNullOrEmpty(this.likeActionController.getLikeCountString())) break block13;
                this.updateBoxCountCaretPosition();
                object = this.likeBoxCountView;
            }
            int n2 = 0;
            object.setVisibility(0);
            ((LinearLayout.LayoutParams)object.getLayoutParams()).gravity = n;
            layoutParams = this.containerView;
            n = this.auxiliaryViewPosition == AuxiliaryViewPosition.INLINE ? n2 : 1;
            layoutParams.setOrientation(n);
    ...
    private void updateLikeStateAndLayout() {
        boolean bl = this.explicitlyDisabled ^ true;
        if (this.likeActionController == null) {
            ...
            bl &= this.likeActionController.shouldEnableView();
        }
        super.setEnabled(bl);
    ...
    public void setForegroundColor(int n) {
        if (this.foregroundColor != n) {
            this.socialSentenceView.setTextColor(n);
        }
    }
    ...
    @Deprecated
    public void setObjectIdAndType(String string, ObjectType objectType) {
        string = Utility.coerceValueIfNullOrEmpty(string, null);
        if (objectType == null) {
            objectType = ObjectType.DEFAULT;
        }
        if (!Utility.areObjectsEqual(string, this.objectId) || objectType != this.objectType) {
            this.setObjectIdAndTypeForced(string, objectType);
            this.updateLikeStateAndLayout();
        }
    }
    ...
    public static enum AuxiliaryViewPosition {
        ...
        private AuxiliaryViewPosition(String string2, int n2) {
            this.stringValue = string2;
            this.intValue = n2;
        }

        static AuxiliaryViewPosition fromInt(int n) {
    ...
    public static enum HorizontalAlignment {
        ...
        private HorizontalAlignment(String string2, int n2) {
            this.stringValue = string2;
            this.intValue = n2;
        }

        static HorizontalAlignment fromInt(int n) {
