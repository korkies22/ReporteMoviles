...
implements RequestOutputStream {
    ...
    ProgressOutputStream(OutputStream outputStream, GraphRequestBatch graphRequestBatch, Map<GraphRequest, RequestProgress> map, long l) {
        super(outputStream);
    ...
    private void addProgress(long l) {
        if (this.currentRequestProgress != null) {
            this.currentRequestProgress.addProgress(l);
        }
        this.batchProgress += l;
