...
public class ToolTipPopup {
    ...
    public ToolTipPopup(String string, View view) {
        this.mText = string;
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            this.mPopupContent.measure(View.MeasureSpec.makeMeasureSpec((int)n, (int)Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec((int)n2, (int)Integer.MIN_VALUE));
