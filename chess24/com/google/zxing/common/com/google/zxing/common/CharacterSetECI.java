...
public enum CharacterSetECI {
    ...
    static {
        ...
        for (CharacterSetECI characterSetECI : CharacterSetECI.values()) {
            for (int n : characterSetECI.values) {
                VALUE_TO_ECI.put(n, characterSetECI);
            }
            NAME_TO_ECI.put(characterSetECI.name(), characterSetECI);
            for (int n : characterSetECI.otherEncodingNames) {
                NAME_TO_ECI.put((String)n, characterSetECI);
            }
        }
    }
    ...
    private /* varargs */ CharacterSetECI(int n2, String ... arrstring) {
        this.values = new int[]{n2};
        this.otherEncodingNames = arrstring;
    }

    private /* varargs */ CharacterSetECI(int[] arrn, String ... arrstring) {
        this.values = arrn;
        this.otherEncodingNames = arrstring;
    }
