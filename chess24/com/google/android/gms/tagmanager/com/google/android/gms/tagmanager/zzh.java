...
class zzh
extends zzam {
    private static final String ID = zzag.zzdg.toString();
    ...
    public zzaj.zza zzY(Map<String, zzaj.zza> object) {
        try {
            object = zzdm.zzR(this.mContext.getPackageManager().getPackageInfo((String)this.mContext.getPackageName(), (int)0).versionCode);
            return object;
        }
