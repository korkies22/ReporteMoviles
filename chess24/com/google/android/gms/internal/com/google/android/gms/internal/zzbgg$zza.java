...
public static final class zzbgg.zza
extends zzbun<zzbgg.zza> {
    public long zzbLh;
    ...
    public static zzbgg.zza zzP(byte[] arrby) throws zzbus {
        return zzbut.zza(new zzbgg.zza(), arrby);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof zzbgg.zza)) {
            return false;
        }
        object = (zzbgg.zza)object;
    ...
    public zzbgg.zza zzW(zzbul zzbul2) throws IOException {
        int n;
