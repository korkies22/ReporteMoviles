...
public static final class zzaj.zza
extends zzbun<zzaj.zza> {
    private static volatile zzaj.zza[] zzlw;
    ...
    public long zzlC;
    public boolean zzlD;
    public zzaj.zza[] zzlE;
    public int[] zzlF;
    public boolean zzlG;
    public zzaj.zza[] zzlx;
    public zzaj.zza[] zzly;
    public zzaj.zza[] zzlz;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof zzaj.zza)) {
            return false;
        }
        object = (zzaj.zza)object;
    ...
    public zzaj.zza zzP() {
        this.type = 1;
        this.string = "";
        this.zzlx = zzaj.zza.zzO();
        this.zzly = zzaj.zza.zzO();
        this.zzlz = zzaj.zza.zzO();
        this.zzlA = "";
        this.zzlB = "";
        this.zzlC = 0L;
        this.zzlD = false;
        this.zzlE = zzaj.zza.zzO();
    ...
    public zzaj.zza zzx(zzbul zzbul2) throws IOException {
        block28 : do {
            int n = zzbul2.zzacu();
            switch (n) {
                int n2;
                ...
                case 90: {
                    n3 = zzbuw.zzc(zzbul2, 90);
                    n = this.zzlE == null ? 0 : this.zzlE.length;
                    arrobject = new zzaj.zza[n3 + n];
                    n3 = n;
                    if (n != 0) {
                    ...
                    while (n3 < arrobject.length - 1) {
                        arrobject[n3] = (int)new zzaj.zza();
                        zzbul2.zza((zzbut)arrobject[n3]);
                        zzbul2.zzacu();
                        ++n3;
                    }
                    arrobject[n3] = (int)new zzaj.zza();
                ...
                case 80: {
                    ...
                    n3 = this.zzlF == null ? 0 : this.zzlF.length;
                    if (n3 == 0 && n == arrobject.length) {
                        this.zzlF = arrobject;
                        continue block28;
                    }
                    int[] arrn = new int[n3 + n];
                    if (n3 != 0) {
                        System.arraycopy(this.zzlF, 0, arrn, 0, n3);
                    }
                    System.arraycopy(arrobject, 0, arrn, n3, n);
                    this.zzlF = arrn;
                    continue block28;
                }
                case 72: {
