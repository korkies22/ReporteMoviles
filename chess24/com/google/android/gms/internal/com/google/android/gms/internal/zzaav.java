...
public class zzaav {
    ...
    public zzaav(Activity activity) {
        ...
        boolean bl = zzs.zzyx() || activity instanceof FragmentActivity;
        zzac.zzb(bl, (Object)"This Activity is not supported before platform version 11 (3.0 Honeycomb). Please use FragmentActivity instead.");
        this.zzaBr = activity;
    }
