...
final class CollapsingTextHelper {
    ...
    private boolean areTypefacesDifferent(Typeface typeface, Typeface typeface2) {
        if (typeface != null && !typeface.equals((Object)typeface2) || typeface == null && typeface2 != null) {
            return true;
        }
        return false;
    }
    ...
    private void calculateUsingTextSize(float f) {
        ...
        boolean bl2 = CollapsingTextHelper.isClose(f, this.mCollapsedTextSize);
        boolean bl3 = true;
        if (bl2) {
