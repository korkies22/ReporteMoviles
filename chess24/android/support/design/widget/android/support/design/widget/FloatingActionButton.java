...
extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int n) {
        ...
        this.mCustomSize = context.getDimensionPixelSize(R.styleable.FloatingActionButton_fabCustomSize, 0);
    ...
    protected void onMeasure(int n, int n2) {
        ...
        this.setMeasuredDimension(this.mShadowPadding.left + n + this.mShadowPadding.right, n + this.mShadowPadding.top + this.mShadowPadding.bottom);
    }
