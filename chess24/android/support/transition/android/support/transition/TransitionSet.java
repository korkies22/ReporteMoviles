...
extends Transition {
    ...
    @NonNull
    @Override
    public TransitionSet addTarget(@NonNull String string) {
        for (int i = 0; i < this.mTransitions.size(); ++i) {
            this.mTransitions.get(i).addTarget(string);
        }
    ...
    public Transition excludeTarget(@NonNull String string, boolean bl) {
        for (int i = 0; i < this.mTransitions.size(); ++i) {
            this.mTransitions.get(i).excludeTarget(string, bl);
        }
    ...
    @NonNull
    @Override
    public TransitionSet removeTarget(@NonNull String string) {
        for (int i = 0; i < this.mTransitions.size(); ++i) {
            this.mTransitions.get(i).removeTarget(string);
        }
    ...
    String toString(String string) {
        Object object = super.toString(string);
        for (int i = 0; i < this.mTransitions.size(); ++i) {
            StringBuilder stringBuilder = new StringBuilder();
