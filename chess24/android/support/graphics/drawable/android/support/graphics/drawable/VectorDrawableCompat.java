...
extends VectorDrawableCommon {
     ...
     */
    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources object, @DrawableRes int n, @Nullable Resources.Theme theme) {
        int n2;
        void var2_5;
        ...
        if (n2 == 2) return VectorDrawableCompat.createFromXmlInner(object, (XmlPullParser)xmlResourceParser, attributeSet, (Resources.Theme)var2_5);
        try {
        ...
        while (n != 1 && (xmlPullParser.getDepth() >= n2 + 1 || n != 3)) {
            ...
            if (n == 2) {
                ...
                if (SHAPE_PATH.equals(object)) {
                    ...
                    object.inflate(resources, attributeSet, theme, xmlPullParser);
                    vGroup.mChildren.add(object);
                    if (object.getPathName() != null) {
                        vPathRenderer.mVGTargetsMap.put(object.getPathName(), object);
                    }
                    n4 = 0;
                    n3 = vectorDrawableCompatState.mChangingConfigurations;
                    vectorDrawableCompatState.mChangingConfigurations = object.mChangingConfigurations | n3;
                    ...
                    vectorDrawableCompatState.mChangingConfigurations = object.mChangingConfigurations | n4;
                    n4 = n3;
                } else {
                    n4 = n3;
                    if (SHAPE_GROUP.equals(object)) {
                        ...
                        if (object.getGroupName() != null) {
                            vPathRenderer.mVGTargetsMap.put(object.getGroupName(), object);
                        }
                        n4 = vectorDrawableCompatState.mChangingConfigurations;
                        vectorDrawableCompatState.mChangingConfigurations = object.mChangingConfigurations | n4;
                        n4 = n3;
    ...
    private void printGroupTree(VGroup vGroup, int n) {
        ...
        Log.v((String)LOGTAG, (String)stringBuilder.toString());
        for (n2 = n3; n2 < vGroup.mChildren.size(); ++n2) {
    ...
    Object getTargetByName(String string) {
        return this.mVectorState.mVPathRenderer.mVGTargetsMap.get(string);
    }
