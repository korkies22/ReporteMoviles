...
implements Animatable2Compat {
     ...
     */
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context object, @DrawableRes int n) {
        int n2;
        if (Build.VERSION.SDK_INT >= 24) {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (n != 1 && (xmlPullParser.getDepth() >= n2 + 1 || n != 3)) {
            if (n == 2) {
                ...
                if (ANIMATED_VECTOR.equals(string)) {
                    string = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE);
                    n = string.getResourceId(0, 0);
                    if (n != 0) {
                    ...
                    string = resources.obtainAttributes(attributeSet, AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET);
                    object = string.getString(0);
                    n = string.getResourceId(1, 0);
                    if (n != 0) {
