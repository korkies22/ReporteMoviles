...
implements DialogInterface {
    ...
    public static class Builder {
        ...
        public Builder setCursor(Cursor cursor, DialogInterface.OnClickListener onClickListener, String string) {
        ...
        public Builder setMultiChoiceItems(Cursor cursor, String string, String string2, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            this.P.mCursor = cursor;
            this.P.mOnCheckboxClickListener = onMultiChoiceClickListener;
        ...
        public Builder setSingleChoiceItems(Cursor cursor, int n, String string, DialogInterface.OnClickListener onClickListener) {
            this.P.mCursor = cursor;
            this.P.mOnClickListener = onClickListener;
