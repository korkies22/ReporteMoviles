...
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>(){
        ...
        public void removeTile(int n, int n2) {
            ...
            if (tile == null) {
                ...
                tile.append(n2);
                Log.e((String)AsyncListUtil.TAG, (String)tile.toString());
                return;
            }
            AsyncListUtil.this.mBackgroundProxy.recycleTile(tile);
        }
    ...
    int mRequestedGeneration = this.mDisplayedGeneration = 0;
    ...
    /* varargs */ void log(String string, Object ... arrobject) {
        StringBuilder stringBuilder = new StringBuilder();
