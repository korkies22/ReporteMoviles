...
class ViewInfoStore {
    ...
    boolean isDisappearing(RecyclerView.ViewHolder object) {
        if ((object = (InfoRecord)this.mLayoutHolderMap.get(object)) != null && (object.flags & 1) != 0) {
            return true;
        }
        return false;
    }
    ...
    boolean isInPreLayout(RecyclerView.ViewHolder object) {
        if ((object = (InfoRecord)this.mLayoutHolderMap.get(object)) != null && (object.flags & 4) != 0) {
            return true;
        }
        return false;
    }
