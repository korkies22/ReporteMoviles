...
extends TextView {
    ...
    protected void onMeasure(int n, int n2) {
        ...
        if (layout != null && (n3 = layout.getLineCount()) > 0 && layout.getEllipsisCount(n3 - 1) > 0) {
            this.setSingleLine(false);
            this.setMaxLines(2);
            layout = this.getContext().obtainStyledAttributes(null, R.styleable.TextAppearance, 16842817, 16973892);
