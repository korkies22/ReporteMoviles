...
extends AppCompatProgressBarHelper {
    ...
    void loadFromAttributes(AttributeSet object, int n) {
        ...
        Drawable drawable = object.getDrawableIfKnown(R.styleable.AppCompatSeekBar_android_thumb);
        if (drawable != null) {
    ...
    void setTickMark(@Nullable Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            DrawableCompat.setLayoutDirection(drawable, ViewCompat.getLayoutDirection((View)this.mView));
