...
class OpReorderer {
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int n, AdapterHelper.UpdateOp updateOp, int n2, AdapterHelper.UpdateOp updateOp2) {
        ...
        int n6 = updateOp2.positionStart++;
        AdapterHelper.UpdateOp updateOp3 = null;
        if (n4 > n6 && updateOp.positionStart < updateOp2.positionStart + updateOp2.itemCount) {
            n4 = updateOp2.positionStart;
            n6 = updateOp2.itemCount;
            int n7 = updateOp.positionStart;
            updateOp3 = this.mCallback.obtainUpdateOp(2, updateOp.positionStart + 1, n4 + n6 - n7, null);
