...
extends FrameLayout {
    ...
    private final CardViewDelegate mCardViewDelegate = new CardViewDelegate(){
        ...
        public void setShadowPadding(int n, int n2, int n3, int n4) {
            ...
            CardView.super.setPadding(n + CardView.this.mContentPadding.left, n2 + CardView.this.mContentPadding.top, n3 + CardView.this.mContentPadding.right, n4 + CardView.this.mContentPadding.bottom);
        }
    };
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet colorStateList, int n) {
    ...
    public void setCardBackgroundColor(@ColorInt int n) {
