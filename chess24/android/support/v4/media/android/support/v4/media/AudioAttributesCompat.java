    ...
    public boolean equals(Object object) {
        ...
        if (object != null) {
            ...
            if (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) {
                return this.mAudioAttributesWrapper.unwrap().equals(object.unwrap());
            }
            if (this.mContentType == object.getContentType() && this.mFlags == object.getFlags() && this.mUsage == object.getUsage() && (this.mLegacyStream != null ? this.mLegacyStream.equals(object.mLegacyStream) : object.mLegacyStream == null)) {
                return true;
            }
            return false;
        }
