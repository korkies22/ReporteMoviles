...
extends MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> {
    ...
    MediaBrowserServiceCompat.MediaBrowserServiceImplApi21(Object object, MediaBrowserServiceCompatApi21.ResultWrapper resultWrapper) {
    ...
    void onResultSent(List<MediaBrowserCompat.MediaItem> object) {
        ...
        this.val$resultWrapper.sendResult(object);
    }
}
