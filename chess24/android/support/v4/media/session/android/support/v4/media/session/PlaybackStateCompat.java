...
implements Parcelable {
    ...
    public static PlaybackStateCompat fromPlaybackState(Object object) {
        ...
        if (object != null && Build.VERSION.SDK_INT >= 21) {
            Object object2;
            List<Object> list = PlaybackStateCompatApi21.getCustomActions(object);
            if (list != null) {
                object2 = new ArrayList<CustomAction>(list.size());
                list = list.iterator();
                while (list.hasNext()) {
                    object2.add(CustomAction.fromCustomAction(list.next()));
                }
            } else {
                object2 = null;
            }
    ...
    public static final class CustomAction$Builder {
        ...
        public CustomAction$Builder(String string, CharSequence charSequence, int n) {
