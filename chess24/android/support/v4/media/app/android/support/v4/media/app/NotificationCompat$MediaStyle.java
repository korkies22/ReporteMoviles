...
extends NotificationCompat.Style {
    ...
    public static MediaSessionCompat.Token getMediaSession(Notification notification) {
        if ((notification = android.support.v4.app.NotificationCompat.getExtras(notification)) != null) {
    ...
    RemoteViews generateContentView() {
        ...
        if (n2 > 0) {
            for (int i = 0; i < n2; ++i) {
                ...
                RemoteViews remoteViews2 = this.generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i]));
                remoteViews.addView(R.id.media_actions, remoteViews2);
            }
        }
        if (this.mShowCancelButton) {
    ...
    public /* varargs */ NotificationCompat.MediaStyle setShowActionsInCompactView(int ... arrn) {
