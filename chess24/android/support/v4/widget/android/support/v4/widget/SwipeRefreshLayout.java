...
NestedScrollingChild {
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setProgressRotation((-0.25f + 0.4f * f3 + f4 * 2.0f) * 0.5f);
    ...
    protected void onLayout(boolean bl, int n, int n2, int n3, int n4) {
        ...
        object.layout(n3, n4, n - this.getPaddingLeft() - this.getPaddingRight() + n3, n2 - this.getPaddingTop() - this.getPaddingBottom() + n4);
        n3 = this.mCircleView.getMeasuredWidth();
        n2 = this.mCircleView.getMeasuredHeight();
        object = this.mCircleView;
        object.layout(n - n3, this.mCurrentTargetOffsetTop, (n /= 2) + (n3 /= 2), this.mCurrentTargetOffsetTop + n2);
    }
