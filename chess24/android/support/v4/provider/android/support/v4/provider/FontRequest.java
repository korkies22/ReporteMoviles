...
public final class FontRequest {
    ...
    public FontRequest(@NonNull String charSequence, @NonNull String string, @NonNull String string2, @ArrayRes int n) {
        this.mProviderAuthority = Preconditions.checkNotNull(charSequence);
        this.mProviderPackage = Preconditions.checkNotNull(string);
        this.mQuery = Preconditions.checkNotNull(string2);
    ...
    public FontRequest(@NonNull String charSequence, @NonNull String string, @NonNull String string2, @NonNull List<List<byte[]>> list) {
        this.mProviderAuthority = Preconditions.checkNotNull(charSequence);
        this.mProviderPackage = Preconditions.checkNotNull(string);
        this.mQuery = Preconditions.checkNotNull(string2);
