...
lbl128: // 2 sources:
        ...
        if (this.mIsLongpressEnabled) {
            this.mHandler.removeMessages(2);
            this.mHandler.sendEmptyMessageAtTime(2, this.mCurrentDownEvent.getDownTime() + (long)GestureDetectorCompat.GestureDetectorCompatImplBase.TAP_TIMEOUT + (long)GestureDetectorCompat.GestureDetectorCompatImplBase.LONGPRESS_TIMEOUT);
        }
