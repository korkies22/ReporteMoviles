...
public final class RoundedBitmapDrawableFactory {
    ...
    @NonNull
    public static RoundedBitmapDrawable create(@NonNull Resources object, @NonNull String string) {
        if ((object = RoundedBitmapDrawableFactory.create((Resources)object, BitmapFactory.decodeFile((String)string))).getBitmap() == null) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("RoundedBitmapDrawable cannot decode ");
