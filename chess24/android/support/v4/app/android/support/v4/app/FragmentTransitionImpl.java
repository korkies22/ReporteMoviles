        ...
        OneShotPreDrawListener.add((View)viewGroup, new Runnable(){
            ...
            public void run() {
                ...
                for (int i = 0; i < n; ++i) {
                    ...
                    String string = ViewCompat.getTransitionName(view);
                    ViewCompat.setTransitionName(view, (String)map.get(string));
                }
            }
        });
    }
        ...
        OneShotPreDrawListener.add(view, new Runnable(){
            ...
            public void run() {
                ...
                for (int i = 0; i < n; ++i) {
                    ...
                    ViewCompat.setTransitionName(view, FragmentTransitionImpl.findKeyForValue(map, string));
                }
            }
        });
    }
    ...
    void setNameOverridesReordered(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        block0 : for (int i = 0; i < n; ++i) {
            ...
            for (int j = 0; j < n; ++j) {
                ...
                ViewCompat.setTransitionName(arrayList2.get(j), string);
                continue block0;
            }
        }
        OneShotPreDrawListener.add(view, new Runnable(){
