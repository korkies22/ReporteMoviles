...
public class ActivityOptionsCompat {
    ...
    @NonNull
    public static ActivityOptionsCompat makeSceneTransitionAnimation(@NonNull Activity activity, @NonNull View view, @NonNull String string) {
        if (Build.VERSION.SDK_INT >= 21) {
            return ActivityOptionsCompat.createImpl(ActivityOptions.makeSceneTransitionAnimation((Activity)activity, (View)view, (String)string));
        }
        return new ActivityOptionsCompat();
    }
