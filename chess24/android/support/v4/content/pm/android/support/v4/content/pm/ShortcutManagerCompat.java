...
public class ShortcutManagerCompat {
    ...
    @NonNull
    public static Intent createShortcutResultIntent(@NonNull Context object, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
    ...
    public static boolean isRequestPinShortcutSupported(@NonNull Context object) {
        ...
        while (object.hasNext()) {
            String string = ((ResolveInfo)object.next()).activityInfo.permission;
            if (!TextUtils.isEmpty((CharSequence)string) && !INSTALL_SHORTCUT_PERMISSION.equals(string)) continue;
            return true;
        }
        return false;
    }
