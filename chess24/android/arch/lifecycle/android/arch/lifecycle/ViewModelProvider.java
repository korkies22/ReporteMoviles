...
public class ViewModelProvider {
    ...
    @MainThread
    @NonNull
    public <T extends ViewModel> T get(@NonNull String string, @NonNull Class<T> class_) {
        ViewModel viewModel = this.mViewModelStore.get(string);
        if (class_.isInstance(viewModel)) {
            return (T)viewModel;
        }
        class_ = this.mFactory.create(class_);
        this.mViewModelStore.put(string, (ViewModel)((Object)class_));
        return (T)class_;
    }
